...
function gameOver(a) {
    var gameOverAlertElement = "<b>KONIEC GRY </b><br><br> GRACZ " + span[a].dataset.player.toUpperCase() + ' WYGRYWA!! !!! <br><br>' + restartButton;
...
function draw() {
    var drawAlertElement = '<b>REMIS!!!</b><br><br>' + restartButton;
    var div = document.createElement("div");
    div.className = "alert";
